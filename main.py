...
def start_training(char_name: str, char_class: str) -> str:
    if char_class == 'warrior':
        print(f'{char_name}, you are a warrior -'
              f'an excellent melee fighter.')
    if char_class == 'mage':
        print(f'{char_name}, you are a magician -'
              f'an excellent tamer of the elements.')
    if char_class == 'healer':
        print(f'{char_name}, you are a healer - a sorcerer'
              f'who can heal wounds.')
...
def choice_char_class() -> str:
    ...
    while approve_choice != 'y':
        ...
        if char_class == 'healer':
            print('healer.')
        approve_choice = input('press (Y), to confirm your choise'
                               'or any other button'
...
def main():
    ...
    char_name: str = input('...introduce yourself: ')
